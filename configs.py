...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8502869700:AAECtFSiWHG-Q0iTUX_jdlaDeTssHfbM9po")

    # Admin / Owner IDs
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 6422788881 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/62",
        "https://t.me/forward_hack_lnx/63"
    ]
